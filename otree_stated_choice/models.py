...
class Constants(BaseConstants):
    ...
    # Settings
    # ---------------------------------------------------------------------------------------
    name_in_url = 'otree_stated_choice'
    ...
    attributesList = 'Travel time', 'Seat guaranteed', 'Fare',

    # Levels for each attribute
    # N: Levels must be ordered from best to worst
    # TODO: rating questions for subjective orderings
    levelsAttribute1 = '5 min', '10 min', '15 min'
    levelsAttribute2 = 'Yes', 'No'
    levelsAttribute3 = '€0.50', '€1', '€1.50'
